...
- **God Mode**: 38 preset interventions plus a freeform command box ("A small battery company discovers a battery that stores twenty times more energy…"), including delayed commands ("In 3 months, Ceria declares war on Slakevo") recorded as omens and carried out on the day.
