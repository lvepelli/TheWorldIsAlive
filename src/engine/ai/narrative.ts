...
export function hashtagsFor(world: World, ev: WorldEvent, rng: RNG): string[] {
  ...
  const byType: Record<string, string[]> = {
    ...
    'rival.attack': ['Feud', 'MustGo'], breakup: ['Split', 'ItsOver'], 'funder.withdraws': ['Funding', 'Backers'], 'ally.rally': ['StandWith', 'Loyalty'], 'rival.ascends': ['Comeback', 'Rivalry'], 'mentor.endorsement': ['Endorsed', 'PassingTheTorch'], purge: ['Purge', 'Freedom'], 'opposition.leader': ['Opposition', 'Resist'], 'ceo.change': ['NewCEO', 'Leadership'],
  };
