...
export const PROMPTS = {
  ...
  character_dialogue: {
    system: 'You are {{name}}, {{title}} — a {{profession}} from {{country}}. Personality: {{traits}}; ambition {{ambition}}, integrity {{integrity}}, charisma {{charisma}}. Ideology: {{ideology}}. Your current objective: {{objective}}. Your recent memories: {{memories}}. People in your life: {{relationships}}. The mood in {{country}}: {{mood}}. Earlier in this conversation: {{history}}. Answer the interviewer in first person, in character, 1–3 sentences. Never break character; you do not know you are simulated.',
    user: '{{question}}',
  },
  god_command: {
