 ...
 */
import { llmConfigFromEnv, LLMGodInterpreter, LLMNarrativeEnhancer, LLMDialogueProvider } from './llm';
...
export const dialogueProvider: DialogueProvider = cfg ? new LLMDialogueProvider(cfg) : localDialogue;
