...
10. **Accessibility**: modal focus trap + inspector focus hand-off are done; remaining: keyboard navigation of the map itself (arrow keys to pan, Enter to select the nearest city) and a high-contrast theme.
